...
$(function (){
	$.getScript(getContextPath() + "/resources/service/js/home_outbound.js").done(function(script, textStatus) {
...
<div class="content">
	...
	<div id="bxMain" class="bxBpMainWrap" style="display: flex">
		...
		<div class="bxBpHeadWrap" >
			<div class="bxBpHead" >
				...
				<div>
					...
					<a id="home_specialTask" onclick="window.open('${cp }/pop.specialTaskForcePopup.sp', 
                         'newwindow', 
                         'width=1300px, height=900px, location=no, toolbars=no, status=no'); 
              return false;"><span >신종코로나 감염증 대책반</span></a>
					...
					<a id="home_imgOutbound"><img src="${cp }/resources/ecoletree/img/btn_dial.png" />아웃바운드 프리뷰</a>
		...
		<div class="bxEmergencyAlert" style="display: none;">
			...
			<a class="pull-right" onclick="$('.bxEmergency').hide()">닫기</a>
		</div>
		...
		<!-- 시작: 인입정보 -->
		<c:import url="/divs.callInfo_outbound.sp" charEncoding="UTF-8" />
		<!-- 끝: 인입정보 -->
		
		<!-- 시작: 이력 테이블 -->
		<c:import url="/divs.history_outbound.sp" charEncoding="UTF-8" />
		<!-- 끝: 이력 테이블 -->
		
		
		<!-- 시작: 이력 상세 -->
		<c:import url="/divs.historyDetail_outbound.sp" charEncoding="UTF-8"  />
		<!-- 끝: 이력 상세 -->
		...
		<!-- 고객정보 상세 -->
		<!-- display: block; -->
		<div id="home_divUserInfoDetail" class="bxMainPopWrap2" style="display: none;">
			<div class="popupHead">
				<div><img src="${cp }/resources/ecoletree/img/icon_info2.png" /> 고객정보 상세</div>
				<a onclick="$('#home_divUserInfoDetail').hide()">x</a>
			</div>
			<div id="home_divOutboundDetailInfo" class="popupBody">
			</div><!-- ./popupBody -->
		</div>
		
		<!-- 아웃바운드 프리뷰 -->
		<!-- display: block; -->
		<div id="home_divOutbound" class="bxMainPopWrap3" style="display: none;">
			<c:import url="/pop.outboundPopup.sp" charEncoding="UTF-8"  />
		</div>
